...
class MazeMap<T extends Cell> {
  ...
  constructor(grid: T[][]) {
    ...
    this.staticGrids = (this.constructor as typeof MazeMap<T>).getAllStaticGrids(this.grid_) as T[][][];
  ...
  static deserialize(serializedValues: CellSerialization[][], cellClass: CellConstructor): MazeMap<Cell> {
