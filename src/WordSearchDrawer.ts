...
class WordSearchDrawer extends Drawer<Cell> {
  /** @override */
  drawTile(svg: SVGSVGElement, _tileSheetLocation: [number, number], row: number, col: number, letter: string, _tileSheetHref: string) {
  ...
  /** @override */
  updateOrCreateText_(prefix: string, row: number, col: number, text: string): SVGTextElement {
